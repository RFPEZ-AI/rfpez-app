# Sourcing Agent Knowledge Base

## Vendor Requirements Discovery Workflow

### ID: vendor-requirements-workflow
### Type: knowledge
### Importance: 0.90
### Category: workflow
...
### ID: perplexity-vendor-discovery
### Type: knowledge
### Importance: 0.90
### Category: workflow

**Content:**
Comprehensive guide for using Perplexity tools effectively to discover, research, and qualify vendors for RFP opportunities.
...
### ID: development-mode-email-routing
### Type: knowledge
### Importance: 0.95
### Category: workflow
...
### ID: email-whitelist-configuration
### Type: knowledge
### Importance: 0.85
### Category: workflow
...
### ID: vendor-presentation-workflow
### Type: knowledge
### Importance: 0.85
### Category: workflow

**Content:**
Procedure for presenting vendor research findings to user in a professional, organized, and selectable format using document artifacts.
...
Below are qualified vendors matching your requirements for [brief RFP description].

## Selection Instructions
Review the vendors below. Let me know which vendors you'd like me to contact with your RFP invitation.

## Vendor List

| # | Vendor Name | Contact Email | Website | Capabilities | Certifications |
|---|-------------|---------------|---------|--------------|----------------|
| 1 | Acme Lighting Supply | sales@acmelighting.com | www.acmelighting.com | Commercial LED lighting, installation support | Energy Star, GSA Schedule |
...
## Research Sources
*Information gathered from: [list sources like industry directories, vendor websites, reviews, etc.]*
...
**Step 1: Create Document Artifact**
```javascript
