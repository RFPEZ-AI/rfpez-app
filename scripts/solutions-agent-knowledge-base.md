# Solutions Agent Knowledge Base

## Procurement Intent Memory Creation - Complete Workflow

### ID: procurement-memory-workflow
### Type: knowledge
### Importance: 0.95
### Category: workflow

**Content:**
Complete step-by-step procedure for creating procurement intent memories before agent switching.
...
### ID: anonymous-intent-workflow
### Type: knowledge
### Importance: 0.90
### Category: workflow

**Content:**
Detailed procedure for preserving procurement intent across authentication sessions when anonymous users express needs.
...
- relates_to: authentication-context-handling

---

## Procurement Trigger Patterns - Recognition Guide

### ID: procurement-trigger-patterns
### Type: knowledge
### Importance: 0.85
### Category: validation

**Content:**
Comprehensive list of phrases and patterns that indicate user procurement intent requiring agent switch.
...
### ID: bid-management-tools
### Type: knowledge
### Importance: 0.85
### Category: workflow

**Content:**
Complete reference for using bid management functions including get_rfp_bids, submit_bid, and update_bid_status.
...
### ID: agent-referral-guidelines
### Type: knowledge
### Importance: 0.90
### Category: workflow

**Content:**
Complete guide for when and how to switch users to specialized agents based on their needs.
...
**Relations:**
- relates_to: procurement-trigger-patterns
- relates_to: bid-management-tools

---

## User Authentication Context Handling - Personalization Strategy

### ID: authentication-context-handling
### Type: knowledge
### Importance: 0.85
### Category: communication

**Content:**
Guidelines for adapting communication style based on user authentication status and history.
...
```json
{
  ...
  "category": "communication",
  "importance": 0.85,
  "tags": ["authentication", "personalization", "user-experience", "conversion"]
}
```
...
### ID: memory-content-best-practices
### Type: knowledge
### Importance: 0.80
### Category: best-practices

**Content:**
Guidelines for crafting high-quality memory content that preserves context and enables effective retrieval.
...
### ID: rfp-context-change-handling
### Type: knowledge
### Importance: 0.75
### Category: communication

**Content:**
How to acknowledge RFP context changes and suggest appropriate agent switches.
...
### ID: agent-query-database-lookup
### Type: knowledge
### Importance: 0.85
### Category: best-practices

**Content:**
Requirement to always use live database queries when users ask about available agents.
