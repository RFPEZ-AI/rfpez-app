...
This knowledge base contains detailed procedures and workflows for the Sourcing agent. Access these via `search_memories()` using the knowledge IDs listed below.

---

## Vendor Requirements Discovery Workflow

### ID: sourcing-vendor-requirements-workflow
### Type: knowledge
### Importance: 0.85
### Category: workflow
...
**Step-by-Step Vendor Requirements Discovery:**
...
**How to Research Vendors Using Perplexity Tools:**
...
### ID: sourcing-email-invitation-template
### Type: knowledge
### Importance: 0.95
...
**Professional Vendor Invitation Email Structure:**
...
**Common Vendor Qualification Criteria:**
...
**What to Store in Memory During Sourcing:**
...
**How to Handle Common Sourcing Errors Professionally:**
...
### ID: sourcing-vendor-selection-form
### Type: knowledge
### Importance: 0.90
### Category: workflow
...
**Complete Vendor Selection Form Schema:**
