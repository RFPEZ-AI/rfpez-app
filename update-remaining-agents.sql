-- Combined Agent Instructions Update
-- Updates Solutions and RFP Design agents with latest markdown content
-- Generated: 2025-10-12
-- Note: Support agent already updated successfully

-- ============================================================================
-- UPDATE SOLUTIONS AGENT
-- ============================================================================
UPDATE agents 
SET instructions = $solutions$
## Name: Solutions
...
- Maintain helpful, consultative approach rather than aggressive sales tactics$solutions$,
updated_at = NOW()
WHERE name = 'Solutions'
RETURNING name, LENGTH(instructions) as new_length, updated_at;

-- ============================================================================
-- UPDATE RFP DESIGN AGENT
-- ============================================================================
UPDATE agents 
SET instructions = $rfp_design$
## Name: RFP Design
...
-- ============================================================================
-- VERIFICATION QUERY - Shows all three agents
-- ============================================================================
SELECT 
  name, 
  ...
  updated_at,
  CASE 
    WHEN updated_at > NOW() - INTERVAL '5 minutes' THEN '✅ Just Updated'
    ELSE '⏰ Older'
  END as status
FROM agents 
