...
-- Generated on 2025-11-17T03:20:41.711Z
...
SELECT 
  ...
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**Step-by-Step Vendor Requirements Discovery:**
...
```$kb_sourcing_agentknowledgebase_20251117032041$,
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**How to Research Vendors Using Perplexity Tools:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**Professional Vendor Invitation Email Structure:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**Common Vendor Qualification Criteria:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**What to Store in Memory During Sourcing:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**How to Handle Common Sourcing Errors Professionally:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**When to Switch TO Sourcing Agent:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_sourcing_agentknowledgebase_20251117032041$**Complete Vendor Selection Form Schema:**
