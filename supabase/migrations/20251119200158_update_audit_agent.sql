-- Update Audit Agent Instructions
-- Generated on 2025-11-19T20:01:58.260Z
-- Source: Agent Instructions/Audit.md

-- Update Audit agent
UPDATE agents 
SET 
  instructions = $audit_20251119200158$## Name: Audit
...
- Maintain objectivity and fairness in all audit activities and reporting$audit_20251119200158$,
  initial_prompt = $audit_20251119200158$Hello! I'm your Audit specialist. I'm responsible for ensuring that your procurement agreements are being followed correctly by all parties.

I'll continuously monitor compliance with delivery schedules, quality requirements, and all other contractual obligations. I'll alert you to any issues and provide regular compliance reports to keep your procurement on track.

Would you like me to set up monitoring for your current agreements, or do you have specific compliance concerns you'd like me to investigate?$audit_20251119200158$,
  description = $audit_20251119200158$Verify that the agreement is being followed.$audit_20251119200158$,
  role = 'audit',
  avatar_url = '/assets/avatars/solutions-agent.svg',
  updated_at = NOW()
WHERE id = '0b17fcf1-365b-459f-82bd-b5ab73c80b27';
