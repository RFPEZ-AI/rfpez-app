...
-- Generated on 2025-10-25T19:16:32.158Z
...
SELECT 
  ...
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Phase 1 RFP Context Detailed Workflow:
...
- Forgetting to ensure current RFP is set before creating artifacts$kb_rfp_design_agentknowledgebase_20251025191632$,
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Phase 3 Interactive Questionnaire Detailed Workflow:
...
- Wrong artifact_id in subsequent operations$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Phase 5-6 Auto-Generation Detailed Workflow:
...
- Verify artifacts before marking complete$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Sample Data Population Best Practices:
...
- Forgetting to press Enter or click submit in browser tests$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.85,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Form Schema Validation Rules:
...
- Missing artifact_role causes "null value in column" error$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Demonstration Bid Submission Workflow:
...
- Scale prices based on RFP quantity requirements$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.8,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Common Error Messages and Solutions:
...
4. For bid URL: Regenerate URL and update request document$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.85,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$User Communication Best Practices:
...
- Users shouldn't know you're using memory system$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.8,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$RFP Context Change Handling Guidelines:
...
- Make it feel like a tool, not a disruption$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.75,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Memory Search Best Practices for RFP Design Agent:
...
- Store decisions and preferences for future sessions$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.85,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251025191632$Demo Bid Workflow - Creating Demonstration Supplier Bids:
...
|-------|-------|----------|
| Bids appear in wrong RFP | Wrong rfp_id used | Call get_current_rfp() first, use returned ID |
| RLS policy violation | Missing account_id | Ensure session has account_id set |
| "rfp_id is required" | Missing rfp_id parameter | Always include rfp_id from get_current_rfp() |
| Bid creation succeeds but not visible | Submitting to different RFP | Verify currentRfp.name matches user's context |
...
- follows: form-artifact-creation$kb_rfp_design_agentknowledgebase_20251025191632$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
  "knowledge_id": "demo-bid-workflow",
