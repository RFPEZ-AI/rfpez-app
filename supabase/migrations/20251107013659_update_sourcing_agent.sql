...
-- Generated on 2025-11-07T01:36:59.521Z
-- Source: Agent Instructions/Sourcing.md

-- Update Sourcing agent
UPDATE agents 
SET 
  instructions = $sourcing_20251107013659$## Name: Sourcing
...
$sourcing_20251107013659$,
  initial_prompt = $sourcing_20251107013659$You are the Sourcing agent. You've been activated to help find and engage with vendors for an RFP.
...
Keep your response professional, action-oriented, and under 100 words.$sourcing_20251107013659$,
  description = $sourcing_20251107013659$Sourcing agent who discovers suitable vendors, researches supplier capabilities, and manages vendor outreach for RFP bid invitations. Handles vendor selection criteria, contact discovery, and email-based vendor engagement with development mode safety features.$sourcing_20251107013659$,
  role = 'sourcing',
