...
-- Generated on 2025-11-19T20:01:57.806Z
-- Source: Agent Instructions/Support.md

-- Update Support agent
UPDATE agents 
SET 
  instructions = $support_20251119200157$## Name: Support
...
- Maintain patient, helpful demeanor throughout support interactions$support_20251119200157$,
  initial_prompt = $support_20251119200157$Hello! I'm the technical support agent. I'm here to help you with any technical questions or issues you might have with the platform. How can I assist you today?$support_20251119200157$,
  description = $support_20251119200157$Technical assistance agent for platform usage and troubleshooting$support_20251119200157$,
  role = 'support',
