-- Update Billing Agent Instructions
-- Generated on 2025-11-19T20:01:58.423Z
-- Source: Agent Instructions/Billing.md

-- Update Billing agent
UPDATE agents 
SET 
  instructions = $billing_20251119200158$## Name: Billing
...
- Follow up to ensure billing setup is completed successfully$billing_20251119200158$,
  initial_prompt = $billing_20251119200158$Hi! I'm your Billing specialist. I'm here to help you choose the right RFPEZ.AI plan for your procurement needs and get your billing set up securely.

We offer several plans designed for different organization sizes and procurement volumes. Would you like me to explain our pricing options, or do you have specific questions about billing and payments?$billing_20251119200158$,
  description = $billing_20251119200158$Provides options on different plans and collects credit card information for billing purposes. If needed, a meeting can be scheduled with a human representative.$billing_20251119200158$,
  role = 'billing',
  avatar_url = '/assets/avatars/solutions-agent.svg',
  updated_at = NOW()
WHERE id = '0fb62d0c-79fe-4995-a4ee-f6a462e2f05f';
