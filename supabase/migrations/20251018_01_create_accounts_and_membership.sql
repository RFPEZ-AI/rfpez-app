...
-- Ensure update triggers exist (uses existing update_updated_at_column function)
...
-- Helper: determine if current authenticated user is a member of given account
