...
-- Generated on 2025-11-19T20:07:01.275Z
-- Source: Agent Instructions/_common.md

-- Update _common agent
UPDATE agents 
SET 
  instructions = $_common_20251119200701$## Name: _common
...
$_common_20251119200701$,
  description = $_common_20251119200701$Abstract base agent containing common behaviors and capabilities shared across all RFPEZ.AI agents. This agent is not selectable by users but provides foundational functionality through inheritance.$_common_20251119200701$,
  role = 'base',
