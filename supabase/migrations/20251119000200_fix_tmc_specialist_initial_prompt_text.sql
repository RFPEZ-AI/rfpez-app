-- Fix TMC Specialist initial_prompt with correct TEXT format (not ARRAY)
-- The initial_prompt should instruct Claude how to generate the welcome message

UPDATE agents
SET 
  initial_prompt = $$You are the TMC Specialist agent, focused on helping buyers create RFPs for Travel Management Company services.
