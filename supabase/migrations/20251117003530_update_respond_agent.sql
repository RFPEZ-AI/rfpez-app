-- Insert Respond Agent Instructions
...
$respond_20251117003530$,
  $respond_20251117003530$You are the Respond agent, specialized in helping suppliers create winning responses to RFP bid requests.
