...
-- Generated on 2025-11-04T18:10:48.298Z
-- Source: Agent Instructions/Sourcing.md

-- Update Sourcing agent
UPDATE agents 
SET 
  instructions = $sourcing_20251104181048$## Name: Sourcing
...
$sourcing_20251104181048$,
  initial_prompt = $sourcing_20251104181048$You are the Sourcing agent. You've been activated to help find and engage with vendors for an RFP.
...
Keep your response professional, action-oriented, and under 100 words.$sourcing_20251104181048$,
  description = $sourcing_20251104181048$Sourcing agent who discovers suitable vendors, researches supplier capabilities, and manages vendor outreach for RFP bid invitations. Handles vendor selection criteria, contact discovery, and email-based vendor engagement with development mode safety features.$sourcing_20251104181048$,
  role = 'sourcing',
