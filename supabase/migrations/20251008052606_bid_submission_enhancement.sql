...
-- Date: October 8, 2025
-- Purpose: Complete the bid submission workflow with status tracking
-- =======================================================
...
ADD COLUMN IF NOT EXISTS bid_amount DECIMAL(15,2),
...
COMMENT ON COLUMN public.bids.status IS 'Current status: draft, submitted, under_review, clarification_requested, shortlisted, accepted, rejected, withdrawn, expired';
