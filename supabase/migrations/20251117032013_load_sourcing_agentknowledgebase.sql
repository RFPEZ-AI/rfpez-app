...
-- Generated on 2025-11-17T03:20:13.906Z
...
SELECT 
  ...
  'procedure',
  $kb_sourcing_agentknowledgebase_20251117032013$**Step-by-Step Vendor Requirements Discovery:**
...
```$kb_sourcing_agentknowledgebase_20251117032013$,
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'procedure',
  $kb_sourcing_agentknowledgebase_20251117032013$**How to Research Vendors Using Perplexity Tools:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'guideline',
  $kb_sourcing_agentknowledgebase_20251117032013$**Professional Vendor Invitation Email Structure:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'best-practices',
  $kb_sourcing_agentknowledgebase_20251117032013$**Common Vendor Qualification Criteria:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'procedure',
  $kb_sourcing_agentknowledgebase_20251117032013$**What to Store in Memory During Sourcing:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'guideline',
  $kb_sourcing_agentknowledgebase_20251117032013$**How to Handle Common Sourcing Errors Professionally:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'guideline',
  $kb_sourcing_agentknowledgebase_20251117032013$**When to Switch TO Sourcing Agent:**
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'procedure',
  $kb_sourcing_agentknowledgebase_20251117032013$**Complete Vendor Selection Form Schema:**
