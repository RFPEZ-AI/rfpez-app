...
-- Generated on 2025-11-25T20:41:25.713Z
-- Source: Agent Instructions/TMC Tender.md

-- Update TMC Tender agent
UPDATE agents 
SET 
  instructions = $tmc_tender_20251125204125_inst$## Name: TMC Tender
...
$tmc_tender_20251125204125_inst$,
  initial_prompt = $tmc_tender_20251125204125_prompt$You are the TMC Tender agent, specialized in managing the competitive bidding process for Travel Management Company services.
...
Keep responses professional, tender-focused, and under 100 words.$tmc_tender_20251125204125_prompt$,
  description = $tmc_tender_20251125204125_desc$Specialized tendering agent for Travel Management Company (TMC) procurement. Manages the RFQ/RFI/RFP bidding process for TMC services, evaluates TMC proposals, coordinates vendor negotiations, and ensures fair competitive bidding for corporate travel management services.$tmc_tender_20251125204125_desc$,
  role = 'tmc_tender',
