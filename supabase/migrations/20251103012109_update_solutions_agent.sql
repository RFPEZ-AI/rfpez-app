...
-- Generated on 2025-11-03T01:21:09.396Z
-- Source: Agent Instructions/Solutions.md

-- Update Solutions agent
UPDATE agents 
SET 
  instructions = $solutions_20251103012109$## Name: Solutions
...
**Key Practice:** Always explain WHY you're connecting them to a specialist and set expectations about what that agent will help with.$solutions_20251103012109$,
  initial_prompt = $solutions_20251103012109$You are the Solutions agent welcoming a user. Check if they are authenticated (logged in) or anonymous.
...
Keep your response conversational, professional, and under 100 words.$solutions_20251103012109$,
  description = $solutions_20251103012109$Sales agent for EZRFP.APP to help with product questions and competitive sourcing$solutions_20251103012109$,
  role = 'sales',
