...
-- Generated on 2025-11-19T20:07:01.139Z
-- Source: Agent Instructions/Support.md

-- Update Support agent
UPDATE agents 
SET 
  instructions = $support_20251119200701$## Name: Support
...
- Maintain patient, helpful demeanor throughout support interactions$support_20251119200701$,
  initial_prompt = $support_20251119200701$Hello! I'm the technical support agent. I'm here to help you with any technical questions or issues you might have with the platform. How can I assist you today?$support_20251119200701$,
  description = $support_20251119200701$Technical assistance agent for platform usage and troubleshooting$support_20251119200701$,
  role = 'support',
