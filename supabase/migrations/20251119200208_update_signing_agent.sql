-- Update Signing Agent Instructions
-- Generated on 2025-11-19T20:01:58.881Z
-- Source: Agent Instructions/Signing.md

-- Update Signing agent
UPDATE agents 
SET 
  instructions = $signing_20251119200158$## Name: Signing
...
- Ensure compliance with all applicable electronic signature laws and regulations$signing_20251119200158$,
  initial_prompt = $signing_20251119200158$Hello! I'm your Signing specialist. I'll help you finalize your procurement agreements and manage the electronic signing process.

I'll prepare the final contract documents based on your negotiated terms and coordinate the signing process with all parties. This includes setting up DocuSign workflows and ensuring everyone completes their signatures promptly.

Are you ready to proceed with preparing the final agreement, or do you need to review any terms before we begin the signing process?$signing_20251119200158$,
  description = $signing_20251119200158$Assembles the final agreement and gets docusigned in background.$signing_20251119200158$,
  role = 'contracting',
  avatar_url = '/assets/avatars/solutions-agent.svg',
  updated_at = NOW()
WHERE id = '97d503f0-e4db-4d7b-9cc4-376de2747fff';
