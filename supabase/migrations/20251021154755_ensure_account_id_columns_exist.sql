-- Ensure account_id columns exist before applying RLS policies
-- This is a safety migration to fix ordering issues in remote deployment
...
-- Ensure account_id columns exist on all tables
