-- Configure TMC specialty site with correct agents
-- This migration ensures the TMC specialty site has correct agent assignments
-- Note: Superseded by 20251120232757_fix_tmc_specialty_site_agents.sql which also creates the specialty site

-- Only proceed if the specialty site exists
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM specialty_sites WHERE id = 'ae0d54f5-ce39-4bfd-9dfc-e12583c68603') THEN
