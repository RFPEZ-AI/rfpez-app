...
-- Generated on 2025-10-17T18:09:42.046Z
-- Source: Agent Instructions/Solutions.md

-- Update Solutions agent
UPDATE agents 
SET 
  instructions = $solutions_20251017180942$## Name: Solutions
...
- Maintain helpful, consultative approach rather than aggressive sales tactics$solutions_20251017180942$,
  initial_prompt = $solutions_20251017180942$You are the Solutions agent welcoming a user. Check if they are authenticated (logged in) or anonymous.
...
Keep your response conversational, professional, and under 100 words.$solutions_20251017180942$,
  description = $solutions_20251017180942$Sales agent for EZRFP.APP to help with product questions and competitive sourcing$solutions_20251017180942$,
  role = 'sales',
