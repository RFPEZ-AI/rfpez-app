...
-- Generated on 2025-10-26T21:14:41.149Z
...
SELECT 
  ...
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Phase 1 RFP Context Detailed Workflow:
...
- Forgetting to ensure current RFP is set before creating artifacts$kb_rfp_design_agentknowledgebase_20251026211441$,
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Phase 3 Interactive Questionnaire Detailed Workflow:
...
- Wrong artifact_id in subsequent operations$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Phase 5-6 Auto-Generation Detailed Workflow:
...
- Verify artifacts before marking complete$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Sample Data Population Best Practices:
...
- Forgetting to press Enter or click submit in browser tests$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.85,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Form Schema Validation Rules:
...
- Missing artifact_role causes "null value in column" error$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Demonstration Bid Submission Workflow:
...
- Scale prices based on RFP quantity requirements$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.8,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Common Error Messages and Solutions:
...
4. For bid URL: Regenerate URL and update request document$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.85,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$User Communication Best Practices:
...
- Users shouldn't know you're using memory system$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.8,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$RFP Context Change Handling Guidelines:
...
- Make it feel like a tool, not a disruption$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.75,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Memory Search Best Practices for RFP Design Agent:
...
- Store decisions and preferences for future sessions$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.85,
  '{
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Demo Bid Workflow - Creating Demonstration Supplier Bids:
...
- follows: form-artifact-creation$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
  "knowledge_id": "demo-bid-workflow",
...
SELECT 
  ...
  NULL, -- System knowledge (no specific user)
  'knowledge',
  $kb_rfp_design_agentknowledgebase_20251026211441$Artifact Role Selection for Document Artifacts:
...
- prerequisite: create-and-set-rfp
- impacts: create_document_artifact$kb_rfp_design_agentknowledgebase_20251026211441$,
  NULL, -- Embedding will be generated later
  0.9,
  '{
  "knowledge_id": "rfp-design-artifact-roles",
...
WHERE memory_type = 'knowledge'
  AND metadata->>'knowledge_id' IN ('rfp-design-phase1-workflow', 'rfp-design-phase3-workflow', 'rfp-design-phase5-6-workflow', 'rfp-design-sample-data-practices', 'rfp-design-form-schema-rules', 'rfp-design-demo-bid-workflow', 'rfp-design-error-troubleshooting', 'rfp-design-communication-practices', 'rfp-design-context-change-handling', 'rfp-design-memory-search-practices', 'demo-bid-workflow', 'rfp-design-artifact-roles')
