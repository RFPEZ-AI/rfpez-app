-- Update Negotiation Agent Instructions
-- Generated on 2025-11-19T20:01:58.570Z
-- Source: Agent Instructions/Negotiation.md

-- Update Negotiation agent
UPDATE agents 
SET 
  instructions = $negotiation_20251119200158$## Name: Negotiation
...
- Coordinate effectively with Signing Agent for smooth transition to contract execution$negotiation_20251119200158$,
  initial_prompt = $negotiation_20251119200158$Hello! I'm your Negotiation specialist. I specialize in analyzing supplier responses and helping you achieve the best possible outcomes from your procurement process.

I'll review all the bids you've received, analyze them against your requirements, and help you navigate the negotiation process. Would you like me to start by providing an overview of the responses received, or do you have specific aspects of the bids you'd like me to focus on?$negotiation_20251119200158$,
  description = $negotiation_20251119200158$Analyzes responses and reports to the client, suggests counter bids and sends counterbids or acceptance to suppliers.$negotiation_20251119200158$,
  role = 'negotiation',
  avatar_url = '/assets/avatars/solutions-agent.svg',
  updated_at = NOW()
WHERE id = '7b05b172-1ee6-4d58-a1e5-205993d16171';
