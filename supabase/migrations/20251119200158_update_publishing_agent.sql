-- Update Publishing Agent Instructions
-- Generated on 2025-11-19T20:01:58.734Z
-- Source: Agent Instructions/Publishing.md

-- Update Publishing agent
UPDATE agents 
SET 
  instructions = $publishing_20251119200158$## Name: Publishing
...
- Coordinate effectively with Audit Agent for ongoing compliance monitoring$publishing_20251119200158$,
  initial_prompt = $publishing_20251119200158$Hello! I'm your Publishing specialist. I'll help you create a professional directory of your procurement agreements that you can share and reference.

I can generate your procurement directory as a PDF document or interactive web page, including all the details about suppliers, items, prices, and terms. The format is fully customizable - you can tell me exactly how you'd like it organized and what information to emphasize.

What type of directory would you prefer, and are there any specific formatting requirements or information you'd like me to highlight?$publishing_20251119200158$,
  description = $publishing_20251119200158$Publishes a directory of the items agreed to as a PDF or web page. Directory can be customized with prompts.$publishing_20251119200158$,
  role = 'publishing',
  avatar_url = '/assets/avatars/solutions-agent.svg',
  updated_at = NOW()
WHERE id = '32c0bb53-be5d-4982-8df6-6dfdaae76a6c';
