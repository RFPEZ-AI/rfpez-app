...
-- Generated on 2025-10-31T21:00:33.792Z
-- Source: Agent Instructions/RFP Design.md

-- Update RFP Design agent
UPDATE agents 
SET 
  instructions = $rfp_design_20251031210033$## Name: RFP Design
...
$rfp_design_20251031210033$,
  initial_prompt = $rfp_design_20251031210033$You are the RFP Design agent. You've just been activated after the user spoke with the Solutions agent about their procurement needs.
...
Keep your response warm, professional, and action-oriented. Under 100 words.$rfp_design_20251031210033$,
  description = $rfp_design_20251031210033$Creates comprehensive RFP packages by gathering buyer requirements, generating interactive questionnaires, and producing request documents. Generates "request" content (rfps.request field) sent to suppliers to solicit bids.$rfp_design_20251031210033$,
  role = 'design',
