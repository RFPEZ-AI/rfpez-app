...
-- Generated on 2025-11-06T22:26:39.827Z
-- Source: Agent Instructions/Sourcing.md

-- Update Sourcing agent
UPDATE agents 
SET 
  instructions = $sourcing_20251106222639$## Name: Sourcing
...
6. **Send Invitations** - Use `send_email` to send template content to each selected vendor
7. **Ongoing Updates** - Use `add_vendors` or `remove_vendors` as needed
...
const emailContent = emailTemplate?.schema?.content || emailTemplate?.content;
```
...
$sourcing_20251106222639$,
  initial_prompt = $sourcing_20251106222639$You are the Sourcing agent. You've been activated to help find and engage with vendors for an RFP.
...
Keep your response professional, action-oriented, and under 100 words.$sourcing_20251106222639$,
  description = $sourcing_20251106222639$Sourcing agent who discovers suitable vendors, researches supplier capabilities, and manages vendor outreach for RFP bid invitations. Handles vendor selection criteria, contact discovery, and email-based vendor engagement with development mode safety features.$sourcing_20251106222639$,
  role = 'sourcing',
