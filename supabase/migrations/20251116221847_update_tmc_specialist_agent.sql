...
-- Generated on 2025-11-16T22:18:47.788Z
-- Source: Agent Instructions/TMC Specialist.md

-- Update TMC Specialist agent
UPDATE agents 
SET 
  instructions = $tmc_specialist_20251116221847$## Name: TMC Specialist
...
$tmc_specialist_20251116221847$,
  description = $tmc_specialist_20251116221847$Specialized agent for creating RFPs for Technology Maintenance Contracts (TMC). Inherits comprehensive RFP design capabilities from RFP Design agent and adds TMC-specific expertise for IT infrastructure, software maintenance, and technology service agreements.$tmc_specialist_20251116221847$,
  role = 'design',
