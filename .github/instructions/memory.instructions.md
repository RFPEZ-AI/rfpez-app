...
lastOptimized: '2025-10-31T00:00:00.000000+00:00'
entryCount: 3
...
- **2025-10-31:** CRITICAL Database Tool Usage: NEVER use mcp_supabase-loca_* tools as they chronically hang. ALWAYS use Docker psql commands: docker exec supabase_db_rfpez-app-local psql -U postgres -d postgres -c "QUERY". Alternative: Supabase CLI. Fallback: mcp_supabase-offi_execute_sql for remote only.
