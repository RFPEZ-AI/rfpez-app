...
- **2025-09-27 16:54:** MCP Integration: Use Supabase MCP tools for SQL operations, not raw queries. MCP Server uses JSON-RPC 2.0 protocol. Edge Functions: mcp-server (protocol) and claude-api (HTTP REST). Test with MCPTestComponent for browser debugging.
